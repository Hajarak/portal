...
<div class="w3-bar-block">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="questions/add_theory.php"> edit Theory</a>
    <a class="dropdown-item" href="questions/add_blanks.php"> edit fill in the blamk</a>
    <a class="dropdown-item" href="questions/add_multiples.php"> edit multiple choice</a>
